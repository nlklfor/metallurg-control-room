    ...
    <>
      ...
      {!mobileOpen && (
        <button
          ...
          className="fixed left-4 top-4 z-40 block lg:hidden rounded bg-[#111111] p-2 text-white"
        >
          <Menu size={20} />
        </button>
      )}
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-screen w-[260px] flex-col bg-[#111111] text-white transition-transform duration-200 lg:hidden",
      ...
      >
        ...
        <div className="border-t border-[#222] px-5 pb-5 pt-4">
          ...
          <button
            ...
            className="mt-3 flex items-center gap-2 text-[11px] uppercase tracking-[0.15em] text-[#6b7280] hover:text-white"
          >
